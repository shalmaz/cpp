/*
	...
	(The nearest star after the sun is about 4.2 light years away.) Use type double (as in Listing 2.4) and this conversion factor: 1 light year = 63,240 astronomical units 
*/
...
double lightToAU(double lightYears)
{
...
int main()
{
	...
	double lightYears;
	cin >> lightYears;
	cout << lightYears << " light years = " << lightToAU(lightYears) << " astronomical units" << endl;
	return 0;
}